function generatorTRPrtcp(category, yearTR, nup, object, extensiveValue, dayTR, monthTR, cmdName, postCmd, nameTR, postGrad, role, table, totalValue, secondTable, var12, var13, var14, var62, var1111){
        ...
        content: [
            {image: './public/img/blazon.png',width:66, heigh: 99, alignment: 'center', margin: [1,1,1,4]},
            {
                text: [
                    ...
                    `TERMO DE REFERÊNCIA ${category} (COMPRAS) \n`,
                    `${category} Nº___/${yearTR}\n`,
            ...
            },
            {
                ...
                table: {
                    ...
                    body: [
                        [
                            {
                                text: 'ÓRGÃO GERENCIADOR: ARSENAL DE GUERRA DE SÃO PAULO',
                                style: 'innerTable',
                                alignment: 'justify'
 ...
 em remessa única, no seguinte endereço: Rodovia Marechal Rondon, km 29, s/n, Centro, Barueri – SP. \n\n',
                    var62,
...
module.exports = generatorTRPrtcp