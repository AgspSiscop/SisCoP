...
function generatorACPP(nup, namesAnaliseCritica, nameAnaliseCritica, percentage ,dayAnaliseCritica,monthAnaliseCritica,yearAnaliseCritica, objectName,var111,var112,var311,var312){
    ...
    const docDefinitions = {
        content: [
            ...
            {text: [{text: `${var111}, que dispõe sobre os procedimentos administrativos básicos para a realização de pesquisa de preços para aquisição de bens e contratação de serviços em geral, `}],style: 'defaultStyle'},
            {text: [{text: `${var112}.\n\n`}],style: 'defaultStyle'},            
            {
                text: [
